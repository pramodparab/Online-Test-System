# Generated by Django 2.2.7 on 2020-01-05 07:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option1', ckeditor_uploader.fields.RichTextUploadingField(max_length=100)),
                ('option2', ckeditor_uploader.fields.RichTextUploadingField(max_length=100)),
                ('option3', ckeditor_uploader.fields.RichTextUploadingField(max_length=100)),
                ('option4', ckeditor_uploader.fields.RichTextUploadingField(max_length=100)),
